...
if (isset($_POST['cetak'])) {
    ...
    $query  = mysqli_query($db, "SELECT * FROM pengadaan WHERE tgl_pengadaan BETWEEN '$mintgl' AND '$maxtgl' ORDER BY tgl_pengadaan ASC");
    ...
    if ($hitung > 0) {
        ...
        echo "<script>window.location='admin.php?page=ceklapbeli'</script>";
    }
}
?>
<div class="container-fluid">
    <ol class="breadcrumb mt-4">
        ...
        <li class="breadcrumb-item active">Cek Laporan Pengadaan Bahan Baku</li>
    </ol>
    <div class="card mb-4">
        <div class="card-header">
            <b>Cek Laporan Pengadaan Bahan Baku</b>
        </div>
