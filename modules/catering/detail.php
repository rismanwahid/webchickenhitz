        ...
        <div class="row mb-2">
            <div class="col-sm-12">
                <ol class="breadcrumb mt-4">
                    <li class="breadcrumb-item"><a href="admin.php?page=catering">Data Catering</a></li>
                    <li class="breadcrumb-item active">Detail Catering</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <b>Detail Catering</b>
                        <a href="admin.php?page=catering" type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div class="card-body">
                        ...
                        $query = mysqli_query($db, "SELECT penjualan.kd_penjualan,penjualan.tgl_jual,pelanggan.nm_plg,penjualan.status,penjualan.tgl_kirim,pembayaran.status_bayar,pembayaran.tipe_bayar,pembayaran.gambar_resi,penjualan.tipe_ambil,penjualan.tipe_jual FROM penjualan JOIN pelanggan ON penjualan.id_pelanggan=pelanggan.id_pelanggan JOIN pembayaran ON pembayaran.kd_penjualan=penjualan.kd_penjualan WHERE penjualan.kd_penjualan='$kdjual'");
                        ...
                        <table>
                            ...
                            <?php if ($hasil['status_bayar'] != 'Belum Melakukan Transfer') { ?>
                                <tr>
                                    <td>Gambar Resi</td>
                                    <td>:</td>
